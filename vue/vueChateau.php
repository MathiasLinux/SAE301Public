        ...
        <div class="contourBiens">
            <div class="bien">
                ...
                <div class="localisationChateau">
                    ...
                    <div class="titreChateau">Chambord France</div>
                </div>
                <div>
                    <div class="prixChateaux">47 000 000 €</div>
                    <div class="ligneIcone">
                        <div class="iconeChateau">
                            <svg class="iconeChateau" id="bed" data-name="bed" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="iconeChateau">
                            <svg class="iconeChateau" id="bathtub" data-name="bathub" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="ligneIcone">
                        <div class="iconeChateau">
                            <svg class="iconeChateau" id="surface" data-name="surface"
                                ...
                                <g id="Calque_1-2" data-name="Calque 1" fill="#fff">
                                    <g>
                                        ...
                                        <rect x=".24" y="60.27" width="102.84" height="103.33" rx="22.3" ry="22.3"
                                              style="fill: #fff;"/>
                                    </g>
                                </g>
                            </svg>
                        ...
                        <div class="iconeChateau">
                            <svg class="iconeChateau" id="dinning_table" data-name="dinning_table"
                                 xmlns="http://www.w3.org/2000/svg"
